...
pieces = [rook(0, 7*square_size, screen, False), rook(7*square_size, 0, screen, False), rook(0, 6*square_size, screen, False), bishop(2*square_size, 0, screen, True), rook(7*square_size, 7*square_size, screen, False), bishop(5*square_size, 0, screen, True), bishop(2*square_size,7*square_size, screen, False), bishop(5*square_size, 7*square_size, screen, False)]
